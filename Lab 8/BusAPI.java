...
class BusAPI {
   ...
   *     query fails encapsulated by CompletableFuture.
   */
  private static CompletableFuture<String> httpGet(String url) {
    ...
    .handle((t, e) -> (e == null) ? t : e.toString());
  }
   ...
   *     string if something go wrong. It is encapsulated by a
   *     CompleteableFuture.
   */
   ...
   *     string if the API query failed. It encapsulated by a
   *     CompleteableFuture.
   */
